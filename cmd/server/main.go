...
import (
	...
	"go-moon/internal/auth"       // Auth package
	"go-moon/internal/cache"      // Cache package
	"go-moon/internal/database"   // Actual DB package
	"go-moon/internal/middleware" // Middleware package
	"go-moon/internal/todo"       // Todo package
	"go-moon/internal/user"       // User package
	"go-moon/pkg/config"          // Config package
	"go-moon/pkg/utils"           // JWT Utility
