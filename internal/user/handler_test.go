...
import (
	...
	userMocks "github.com/your-username/go-moon/internal/user/mocks" // Mock for UserService
)
...
func TestUserHandler_RegisterUser(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		mockUserService.On("Register", mock.AnythingOfType("*gin.Context"), registerReq).Return(expectedUser, nil).Once()
